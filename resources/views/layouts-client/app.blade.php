...
<body class="bg-light">
    ...
    <div class="bg-primary-color text-white py-0 px-3 d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center">
            <img src="{!! asset('assets/images/favicon.png') !!}" class="w-px-40 h-auto rounded-circle me-2"
                style="opacity:.9; width:30px; height:30px; object-fit:cover;">

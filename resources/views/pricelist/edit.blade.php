                ...
                <div class="card-body">
                    <div class="card card-main shadow-sm " id="formCard">
                        ...
                        <div class="card-body pt-0">
                            <!-- FORM UTAMA -->
                            <form action="/pricelist/update" method="post" id="salesForm" class="mt-4">
                                @csrf
                                <div class="row">
                                    <!-- LEFT -->
                                    <div class="col-md-8">
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="d-none" name="customer"
                                                    value="{{ $data->Customer }}">
                                                <input type="text" class="d-none" name="category"
                                                    value="{{ $data->Category }}">
                                                <input type="text" class="d-none" name="carat"
                                                    value="{{ $data->Carat }}">
                                                <select class="form-control select2 readonly">
                                                    <option value="">Pilih Data</option>
                                                    @foreach ($cust as $d)
                                                        <option value="{{ $d->ID }}"
                                                            {{ $data->Customer == $d->ID ? 'selected' : '' }}>
                                                            {{ $d->SW }} ({{ $d->Description }})</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control autonumDec3" name="pricecust"
                                                    placeholder="Description" value="{{ $data->priceCust_format }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>

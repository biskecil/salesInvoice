        ...
        <div class="col-md-6">
            <div class="card shadow-sm">
                <div class="card-header bg-white border-0">
                    <h5 class="mb-0 text-center fw-bold ">Form Produk - Edit</h5>
                </div>
                <div class="card-body">
                    <div class="card card-main shadow-sm " id="formCard">
                        @include('produk.action')
                        <div class="card-body pt-0">
                            <!-- FORM UTAMA -->
                            <form action="/produk/update" method="post" id="salesForm" class="mt-4">
                                @csrf
                                <div class="row">
                                    <!-- LEFT -->
                                    <div class="col-md-8">
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control d-none" value="{{ $data->ID }}" name="id" placeholder="SW">
                                                <input type="text" class="form-control" value="{{ $data->SW }}" name="sw" placeholder="SW" readonly>
                                            </div>
                                        </div>
                                        <div class="mb-2 row">
